...
tri_libs=$(dumpsys package|grep name:com.google.android.trichromelibrary | sed "s/ version:/_/g; s/name://g; /$current_code/d")
squoosh_libs $tri_libs | tee "/data/local/tmp/trichromelibrary-squoosh.log"
echo "If you see any failure messages, just ignore them, because the TrichromeLibrary is being used in other ways."
